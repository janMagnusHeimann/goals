...
enum Constants {
    ...
    enum GitHub {
        ...
        static let redirectURI = "goals://github/callback"
        static let scopes = "read:user repo"
    }

    enum App {
        static let bundleIdentifier = "com.goals.app"
        static let iCloudContainer = "iCloud.com.goals.app"
        static let urlScheme = "goals"
    }
